          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _this6.loading = true;
                _context4.next = 3;
                return axios["delete"]("api/manage/example/" + _this6.editedItem.id).then(function (response) {
              ...
              case 0:
                ...
                return axios.get("/api/problem").then(function (response) {
                  if (response.data.success == true) {
                    ...
                    console.log("problemList", _this7.problemList);
                  }
                });
              ...
              case 0:
                ...
                return axios.get("/api/schedule", {
                  ...
                  if (response.data.success == true) {
                    ...
                    console.log("desserts", _this8.desserts);
                  }
                });
