...
class ManageStdClassroomController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['store', 'payload' => $request->all(), 'status' => $std_classroom->save()]);
    }
    ...
    {
        $manage = ManageStdClassrooms::leftJoin('status', 'manage_std_classrooms.status_id', '=', 'status.statusID')->where('classroom_id', $id)->select()->get();
